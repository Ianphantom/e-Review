...
<head>
  <meta charset="utf-8">
  <title>Welcome to Ereview</title>
  ...
  <header>
    ...
    <div class="navbar navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container">
          <!-- logo -->
          <a class="brand logo" href="index.html"><img width ="100" src="<?php echo base_url();?>assets/img/logo1.jpg" alt=""></a>
          <!-- end logo -->
          <!-- top menu -->
          <div class="navigation">
            <nav>
              <ul class="nav topnav">
                ...
                <li>
                  <a href="<?php echo base_url().'index.php/welcome/signup';?>">Create Account</a>
                </li>
                <li>
